...
public abstract class Piece {
    ...
    */
    ...
    public static Piece getPiece(String pieceOnTile, BoardPos position) {
        ...
        switch (pieceId) {
            case "P" ->
                created = new Pawn(position, team);
            case "B" ->
                created = new Bishop(position, team);
            case "K" ->
                created = new King(position, team);
            case "N" ->
                created = new Knight(position, team);
            case "Q" ->
                created = new Queen(position, team);
            case "R" ->
                created = new Rook(position, team);

            case "O" ->
                created = new Rock(position, team);
